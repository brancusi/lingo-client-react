...
var opusLibUrl = require("file!./libopus.js")
var resamplerUrl = require("file!./resampler.js")

importScripts( opusLibUrl, resamplerUrl);
...
onmessage = function( e ){
  switch( e.data.command ){
    ...
    case 'init':
      decoder = new OggOpusDecoder( e.data.config );
      break;
  }
};
